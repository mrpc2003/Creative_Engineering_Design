...
#define _INTERVAL_SERVO   23 // servo interval (unit: ms)
...
// Servo adjustment
#define _DUTY_MAX 2230  // Servo angle: D degree
#define _DUTY_NEU 1593  // Servo angle: 0 degree
#define _DUTY_MIN 667   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return (471+(-1.52*a_value) + ((1.23*0.001) * a_value * a_value)); //2차/
}
